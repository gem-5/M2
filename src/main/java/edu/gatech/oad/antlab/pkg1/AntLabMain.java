...
public class AntLabMain {
	...
	/**
	 * gathers a string from all the other classes and prints the message out to
	 * the console
	 *
	 */
	public void printOutMessage() {
		...
		Person1 p1 = new Person1("Jack Mueller");
		toPrint += p1.toString("jmueller30");
		// Person2 replace P2 with your name
		// and gburdell with your gt id
		Person2 p2 = new Person2("Creston Bunch");
		toPrint += p2.toString("cbunch7");
		// Person3 replace P3 with your name
		// and gburdell3 with your gt id
		Person3 p3 = new Person3("Jong Han (James) Park");
		toPrint += p3.toString("jpark652");
		// Person4 replace P4 with your name
		// and gburdell4 with your gt id
		Person4 p4 = new Person4("Sam Blumenthal");
		toPrint += p4.toString("sblumenthal3");
		// Person5 replace P4 with your name
		// and gburdell5 with your gt id
		Person5 p5 = new Person5("Alex Liu");
		toPrint += p5.toString("aliu46");
